const questions = [
  {
    id: 1,
    question: "تتجمع النجوم في تجمعات مكونة ....",
    answer: "المجرات",
    difficulty: "medium",
  },
  ...
  {
    id: 2,
    question: "ما هو التفسير الأكثر قبولًا حول الانفجار العظيم في بداية الكون؟",
    answer: "توسع الكون من حالة كثافة وحرارة غير محدودة",
  },
  {
    id: 3,
    question:
      "خلال التفاعلات النووية التي تحدث في النجوم، يتم تحويل الهيدروجين إلى....",
    answer: "الهيليوم",
  },
  {
    id: 4,
    question:
      "يتسبب التأثير الجاذبي في تسارع المواد نحو مركز الكواكب مما يؤدي إلى....",
    answer: "ارتفاع درجات الحرارة في اللب الداخلي للكوكب",
    difficulty: "very hard",
  },
  {
    id: 5,
    question:
      "ما السبب وراء استمرار الشمس في إنتاج الطاقة رغم استهلاك الهيدروجين بشكل مستمر؟",
    answer: "لحدوث التفاعلات النووية التي تحول الهيدروجين إلى الهيليوم",
  },
  {
    id: 6,
    question:
      "تحدث الانفجارات النجمية التي تؤدي إلى إنشاء الثقوب السوداء في مرحلة....",
    answer: "النهاية المتقدمة لعمر النجم الضخم",
  },
  {
    id: 7,
    question:
      "في المراحل الأولى من تكون النجوم، يتفاعل الهيدروجين مع الهيليوم لتكوين....",
    answer: "النجوم والمجرات الجديدة",
  },
];
window.onload = () => {
