const questions = [
  {
    ...
    answer:
      "تجمع النجوم في الكون يؤدي إلى تكوين المجرات، وتكوين أنظمة نجمية، وتشكيل تجمعات فلكية مختلفة.",
    difficulty: "medium",
  },
  {
    id: 2,
    ...
    answer:
      "زيادة البعد بين الكواكب السيارة والشمس قد تؤدي إلى انخفاض درجة الحرارة على سطح الكواكب، مما يؤثر في وجود الحياة أو الظروف البيئية المناسبة عليها.",
    difficulty: "medium",
  },
  {
    id: 3,
    ...
    answer:
      "التباعد المستمر بين المجرات يدل على تمدد الكون المستمر وفقًا لنظرية الانفجار العظيم، مما يعكس أن الكون يتسع بشكل دائم.",
    difficulty: "medium",
  },
  {
    id: 4,
    question:
      "ما هي نتيجة تجمد الحلقات الغازية المنفصلة عن السديم طبقًا لنظرية لابلاس؟",
    answer:
      "تجمد الحلقات الغازية المنفصلة عن السديم يؤدي إلى تكوين الكواكب في النظام الشمسي، حيث تندمج الحلقات الغازية مع بعضها لتشكل الأجرام السماوية.",
    difficulty: "hard",
  },
  {
    id: 5,
    question:
      "ما هي النتيجة المترتبة على تعرض السحابة الغازية إلى عمليات تبريد وانكماش طبقًا لنظرية فريد هويل لتفسير نشأة المجموعة الشمسية؟",
    answer:
      "تعرض السحابة الغازية إلى عمليات تبريد وانكماش يؤدي إلى تكون الشمس والكواكب، حيث تبدأ الغازات في التكتل لتشكل الأجرام السماوية المختلفة.",
    difficulty: "medium",
  },
];
window.onload = () => {
