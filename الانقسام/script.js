const questions = [
  ...
  {
    id: 43,
    question: "علل: الأوراق الخضراء تحتوي على الكلوروفيل",
    answer:
      "لأن الكلوروفيل هو الصبغة المسؤولة عن امتصاص الضوء لإتمام عملية البناء الضوئي",
  },
  {
    id: 44,
    question: "علل: يتم تخزين الجلوكوز في صورة نشا في النبات",
    answer:
      "لأن النشا غير ذائب في الماء مما يسهل تخزينه بدون التأثير على الضغط الأسموزي",
  },
  {
    id: 45,
    question: "علل: يستخدم الماء كمذيب في التفاعلات الحيوية",
    answer:
      ".لأن الماء يمتلك خصائص قطبية تسهل إذابة العديد من المواد الكيميائية",
  },
];
window.onload = () => {
